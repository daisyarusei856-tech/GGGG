    ...
    return <div className='prodb-dashboard-page'>
        ...
        <aside className='prodb-help-panel'>
            <article className='prodb-help-panel__welcome'>
                ...
                <img src={lionLogo} alt="ELISY254 DOLLARZONE Lion" className="prodb-help-lion-badge" />
                <h2>WELCOME TO {domain}</h2>
                <p>Load bots, build Blockly strategies and use the tools configured for ELISY254 DOLLARZONE.</p>
            </article>
