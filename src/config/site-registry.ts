...
export const resolveSiteConfig = (hostname?: string): SiteOAuthConfig | undefined => {
    ...
    // Auto-detect localhost or run.app
    if (currentHost.includes('localhost') || currentHost.includes('127.0.0.1') || currentHost.includes('run.app')) {
        return {
            id: 'dev-dynamic',
            hosts: [currentHost],
            ...
            legacy_app_id: process.env.APP_ID || '1089',
